...
function cambiarImagen() {
  ...
  const timestamp = new Date().getTime(); // Generar un número único basado en el tiempo
  img.src = `https://picsum.photos/200/300?random=${timestamp}`; // Agregar el parámetro único
